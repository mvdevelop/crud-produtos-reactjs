...
import { Produto, FormularioProps } from './types';
 ...
 */
export default function Formulario({botao, eventoTeclado, cadastrar, obj, cancelar, remover, alterar}: FormularioProps) {
  return (
